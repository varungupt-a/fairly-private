...
\newcommand{\d10}{D_{10}}
\newcommand{\d11}{D_{11}}
\newcommand{\dya'}{D'_{ya}}
\newcommand{\d10'}{D'_{10}}
\newcommand{\d11'}{D'_{11}}
...
$$\del_{10} = \frac{1}{|\z10|+1} (\sum_{\z10} h(x)+h(z_0)) - \gamma_{10}^{Z}$$
$$\del_{11} = \gamma_{11}^{Z}- \frac{1}{|Z_{11}|-1} (\sum_{Z_{11}} h(x)-h(x_1))$$
\dk {insert template}

$$|\Gamma^{Z'}- \Gamma^{Z}| = \del_{10} + \del_{11}= \frac{\gamma_{10}}{|\z10|-1} + \frac{\gamma_{11}}{|Z_{11}|+1} $$
...
$$\del u(Z,h) = ||(\del\ell,\del{\Gamma})||_1 \approx O(||1/n,1/|\z10|+1/|Z_{11}|||_1)$$
