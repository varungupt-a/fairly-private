...
\[
\gamma_L \leq
\frac{2\epsilon(1+C)\text{OPT}}{T\sqrt{T\ln(\frac{1}{\delta_\eps})}} + \frac{2(1+\ln(n))\sqrt{\ln(\frac{1}{\delta_\eps})}}{\sqrt{T}\eps}
\]
%\section{Appendix}
